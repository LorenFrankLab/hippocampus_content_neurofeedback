...
class ArmEndClusters(dj.Computed):
    ...
    def make(self, key):
                ...
                for tetrode in tet_list:
                    ...
                    try:
                        ...
                        if tet_counter == 0:
                            ...
                            arm1_all_tet_cluster_ids = spike_count_array.index
                        else:
                            arm1_all_tet_spike_count = np.concatenate((arm1_all_tet_spike_count,
                                                                    spike_count_array.values),axis=0)
                            arm1_all_tet_cluster_ids = np.concatenate((arm1_all_tet_cluster_ids,
                        ...
                        if tet_counter == 0:
                            ...
                            arm2_all_tet_cluster_ids = spike_count_array.index
                        else:
                            arm2_all_tet_spike_count = np.concatenate((arm2_all_tet_spike_count,
                                                                    spike_count_array.values),axis=0)
                            arm2_all_tet_cluster_ids = np.concatenate((arm2_all_tet_cluster_ids,
                                                                    spike_count_array.index),axis=0)
        ...
        key["cluster_id"] = arm1_all_tet_cluster_ids
